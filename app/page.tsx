                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Seamless Cross-Chain Transactions</h3>
                  ...
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Automated Liquidity Management</h3>
                      <p className="text-muted-foreground">
                  ...
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Single-Click Execution</h3>
                      <p className="text-muted-foreground">
